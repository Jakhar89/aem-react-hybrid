...
// Selenium Endpoint
let selenium_base_url =
  process.env.SELENIUM_BASE_URL || "http://localhost:4444";
// Browser
let browser = process.env.SELENIUM_BROWSER || "chrome";

// AEM Author
let aem_author_basel_url =
  process.env.AEM_AUTHOR_URL || "http://localhost:6502";
...
// AEM Publish
let aem_publish_basel_url =
  process.env.AEM_PUBLISH_URL || "http://localhost:4503";
